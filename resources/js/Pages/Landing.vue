            ...
            <div class="py-20 px-5 my-auto w-1/3 bg-white rounded-md h-screen min-w-max">
                ...
                <form>
                    ...
                    <div class="grid grid-cols-1 w-full mx-auto mb-10">
                        <Link @click="show = !show" href="/test2" as="button" type="button"
                ...
                <div class="mx-auto w-full grid"> <button
                        class="mx-auto w-48 hover:bg-violet-600/50 form-input rounded-full"> Join Now </button>
                </div>
            </div>
        </div>
    </Transition>
